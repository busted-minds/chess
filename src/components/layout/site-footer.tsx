    ...
    <footer className="border-t border-[var(--border)] bg-[var(--surface-deep)]">
      <div className="mx-auto grid max-w-[1320px] gap-10 px-5 py-14 md:grid-cols-[1.3fr_2fr] md:px-8">
        <div>
          ...
          <div className="mt-6 flex items-center gap-3"><span className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--text-faint)]">Powered by</span><Image src="/brand/busted-minds.png" alt="Powered by Busted Minds" width={115} height={48} className="h-9 w-auto object-contain" /></div>
        </div>
